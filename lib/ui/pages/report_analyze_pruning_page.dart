        ...
        children: [
          pw.TableRow(children: [
            pw.Container(
                ...
                child: pw.Text('Всего ${inspection.cows?.length ?? 0} голов',
                  style: pw.TextStyle(
          ...
          pw.TableRow(children: [
            pw.Row(children: [
              pw.Container(
                  ...
                  child: pw.Text('${cowsHealthyPruning ?? 0} Здоровых голов',
                      style: pw.TextStyle(
                          fontSize: 14, fontWeight: pw.FontWeight.bold))),
              pw.Container(
                  alignment: pw.Alignment.centerLeft,
                  ...
                  width: 277.5,
                  height: 40,
                  child: pw.Text('${inspection.numberOfCases ?? 0} Больных голов',
                      style: pw.TextStyle(
                          fontSize: 14, fontWeight: pw.FontWeight.bold))),
            ]),
          ]),
        ...
        children: [
          pw.TableRow(children: [
            pw.Container(
                ...
                alignment: pw.Alignment.center,
                child: pw.Text(
                    'У ${inspection.numberOfCases ?? 0} больных коров',
                    style: pw.TextStyle(
                        fontSize: 14, fontWeight: pw.FontWeight.bold)))
          ]),
          pw.TableRow(children: [
